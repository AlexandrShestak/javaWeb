...
<head>
  ...
  <!-- Le styles -->
  <link href="${pageContext.servletContext.contextPath}/bootstrap-3.3.5/docs/assets/css/bootstrap.css" rel="stylesheet">
  <style type="text/css">
    form {
      margin-top: 50px;
    }
  ...
  <link rel="shortcut icon" href="${pageContext.servletContext.contextPath}/bootstrap-3.3.5/docs/examples/images/favicon.ico">
  <link rel="apple-touch-icon" href="${pageContext.servletContext.contextPath}/bootstrap-3.3.5/docs/examples/images/apple-touch-icon.png">
  <link rel="apple-touch-icon" sizes="72x72" href="${pageContext.servletContext.contextPath}/bootstrap-3.3.5/docs/examples/images/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="114x114" href="${pageContext.servletContext.contextPath}/bootstrap-3.3.5/docs/examples/images/apple-touch-icon-114x114.png">
</head>
<body>
<div class="container">
  <div class="row">
